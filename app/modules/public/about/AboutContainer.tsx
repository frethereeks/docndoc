...
import { LuBrainCircuit, LuFileChartPie } from "react-icons/lu";
    ...
    return (
        <main className='relative'>
            <section className="relative bg-primary px-4">
                ...
                <div className="relative w-full min-h-[70vh] md:max-w-lg mx-auto flex flex-col justify-center items-center gap-2 text-center text-powder">
                    ...
                    <Link href={"/"} className="flex items-center gap-2 py-2 px-6 md:px-8 bg-white shadow-xl text-primary font-primary font-semibold rounded-sm">Get Started <FaCaretRight /></Link>
            ...
            <section className="bg-white py-14 md:py-20 px-4">
                <div className="container mx-auto flex flex-col md:flex-row-reverse gap-6 md:gap-10">
                    <aside className="flex-1 relative bg-white rounded-md overflow-hidden">
                        <Image src={ASSETS_URL['group_male_content']} alt={'group_male_content'} className='object-cover' fill />
                    </aside>
            ...
            <section className="bg-primary">
                <div className="container mx-auto flex flex-col md:flex-row gap-6 md:gap-10">
                    <aside className="flex-1 relative bg-white overflow-hidden">
                        <Image src={ASSETS_URL['group_male_content']} alt={'group_male_content'} className='object-cover' fill />
                    </aside>
                    <aside className="flex-1 flex flex-col justify-center gap-2 py-20 md:py-24 text-white p-4">
